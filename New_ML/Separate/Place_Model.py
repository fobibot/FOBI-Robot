...
np.save("Saved_Model/Encoded_Input_classes-Place.npy" , encoder_input.classes_) # Save Encoded Model
...
np.save("Saved_Model/Encoded_Output_classes-Place.npy" , encoder_output.classes_) # Save Encoded Model
...
model.save('Saved_Model/Place-model.h5')